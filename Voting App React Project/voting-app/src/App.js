...
import Help from './Components/admin/Pages/Help/Help';
  ...
  return (
    ...
    <ToastContainer/>
      <Routes>
        ...
        <Route path="/AddElection" element={<Protected page={PartyList} />} />
        <Route path="/PartyList" element={<Protected page={Profile} />} />
